...
//           axios.get("http://localhost:8000/api/repairs/"),
//         ]);
...
//             <h4 className="mb-1">DriveLedger Command Center</h4>
//             <p className="text-muted mb-0">
//               Live overview of fleet, finance, assignments, and repairs.
//             </p>
//           </div>
//         </div>
...
//         {pendingRepairs > 0 && (
//           <div className="alert alert-warning">
//             <strong>Repair Attention:</strong> {pendingRepairs} repair request(s)
//             are still pending.
//           </div>
//         )}
