            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00/00/0000" placeholder="DD/MM/YYYY" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00:00:00" placeholder="__:__:__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00/00/0000 00:00:00" placeholder="__/__/___ __:__:__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00000-000" placeholder="____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="0-00-00-00" placeholder="_-__-__-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="000.000.000.000.000,00" placeholder="__.___.__.__,__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask={[/\d/, '.', /\d/, /\d/, /\d/, ',', /\d/, /\d/]} placeholder="#.##0,00" className="form-control" />
            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <IMaskInput mask={[/[1-9]/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask={['(', /[1-9]/, /\d/, ')', ' ', /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="(__)____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask={['(', /[1-9]/, /\d/, /\d/, ')', ' ', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="(___)___-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="[0-9]{2}.[0-9]{4}-[0-9]{4}" placeholder="(__)_____-____" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}" placeholder="___.___.____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="[0-9]{2}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}" placeholder="__.___.___/____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}" placeholder="___.___.___.___" className="form-control" />
