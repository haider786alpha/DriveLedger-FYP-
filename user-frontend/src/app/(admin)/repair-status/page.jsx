...
//           Track repair requests, maintenance issues, and current progress for your assigned vehicle.
//         </p>
...
//                   }}
//                 >
//                   <p style={{ margin: 0, color: "#64748b", fontSize: "13px" }}>Reported Date</p>
...
//                   }}
//                 >
//                   <p style={{ margin: 0, color: "#64748b", fontSize: "13px" }}>Estimated Cost</p>
//                   <strong style={{ display: "block", marginTop: "6px", color: "#0f172a", wordBreak: "break-word" }}>
...
//                   }}
//                 >
//                   <p style={{ margin: 0, color: "#64748b", fontSize: "13px" }}>Repair ID</p>
